        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <!-- Puedes incluir un mensaje o el nombre del proveedor -->
                        <h5 class="card-title">Agregar dirección para: <?= htmlspecialchars($provider->name) ?></h5>
                        <form action="<?= base_url() ?>provider/storeAddress" method="post">
